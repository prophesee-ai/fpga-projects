...
│       └── verification
├── psee_generic
│   ├── kria_generic_RC_0_1_0.tcl
│   ├── kria_generic_system_register.coe
│   ├── constr
│   └── tb
```
...
##### Open the *kria_generic* Vivado Project

To open the project with the Vivado GUI run:

```
$ vivado build/kria_generic/kria_generic.xpr
```

##### Run Generate Bitstream Step

With the *kria_generic* project opened on the Vivado GUI, click on:
...
*build/kria_generic/kria_generic.runs/impl_1/kria_generic.bit*
