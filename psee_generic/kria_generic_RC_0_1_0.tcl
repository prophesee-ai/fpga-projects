...
#
# kria_generic_RC_0_1_0.tcl: Tcl script for re-creating project 'kria_generic'
#
# Generated by Vivado on Thu Feb 22 17:33:10 CET 2024
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/kria_generic_system_register.coe"]"\
 "[file normalize "$origin_dir/constr/kria_generic_pinout_constraints.xdc"]"\
 "[file normalize "$origin_dir/tb/kria_generic/src/tb_local_params.sv"]"\
 "[file normalize "$origin_dir/../common/src/verification/sv/zynq_fpga_bfm.sv"]"\
 "[file normalize "$origin_dir/../common/src/axi4_stream/axi4_pipeline_stage_2.vhd"]"\
 "[file normalize "$origin_dir/../common/src/utils/ccam_utils/xilinx/ccam_utils.vhd"]"\
 "[file normalize "$origin_dir/../common/src/axi4_stream/axi4s_cfg_fifo_merge_2_1.vhd"]"\
 "[file normalize "$origin_dir/../common/src/utils/ccam_evt_formats.vhd"]"\
 "[file normalize "$origin_dir/tb/kria_generic/src/pkg/ccam_evt_types.vhd"]"\
 "[file normalize "$origin_dir/../common/src/utils/ccam_evt_types_v3.vhd"]"\
 "[file normalize "$origin_dir/../common/src/axi4_stream/axi4s_cfg_sync_fifo.vhd"]"\
 "[file normalize "$origin_dir/../common/src/axi4_stream/axi4s_demux_1_2.vhd"]"\
 "[file normalize "$origin_dir/../common/src/axi4_stream/axi4s_fork_1_2.vhd"]"\
 "[file normalize "$origin_dir/../common/src/axi4_stream/axi4s_mux_2_1.vhd"]"\
 "[file normalize "$origin_dir/../common/src/axi4_stream/axi4s_sync_fifo_xpm.vhd"]"\
 "[file normalize "$origin_dir/../common/src/verification/axil_master_bfm/axi_lite_master_bfm.vhd"]"\
 "[file normalize "$origin_dir/../common/src/axi4_stream/axis_ready_pipe.vhd"]"\
 "[file normalize "$origin_dir/../common/src/axi4_stream/axis_serializer.vhd"]"\
 "[file normalize "$origin_dir/../common/src/utils/ccam_evt_type_v2_1.vhd"]"\
 "[file normalize "$origin_dir/../common/src/verification/clk_rst_bfm/clk_rst_bfm.vhd"]"\
 "[file normalize "$origin_dir/../common/src/verification/clk_rst_bfm/clk_rst_gen.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx/xilinx_mipi_tx_2l_ip/crc16_2lane/crc16_2lane.vhd"]"\
 "[file normalize "$origin_dir/../common/src/verification/evt_verification_pkg.vhd"]"\
 "[file normalize "$origin_dir/../common/src/verification/evt20_sequencer.vhd"]"\
 "[file normalize "$origin_dir/../common/src/verification/evt20_stream_reader.vhd"]"\
 "[file normalize "$origin_dir/../common/src/verification/evt30_sequencer.vhd"]"\
 "[file normalize "$origin_dir/../common/src/verification/evt30_stream_reader.vhd"]"\
 "[file normalize "$origin_dir/../common/src/verification/evt_record_generic.vhd"]"\
 "[file normalize "$origin_dir/../common/src/verification/evt_stream_reader.vhd"]"\
 "[file normalize "$origin_dir/../common/src/verification/file_stream_reader.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx/xilinx_mipi_tx_2l_ip/mipi_tx_delay_ctrl/mipi_csi_tx_delay_ctrl.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx/xilinx_mipi_tx_2l_ip/mipi_tx_dphy/mipi_csi_tx_dphy.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx/xilinx_mipi_tx_2l_ip/mipi_tx_packetheader/mipi_csi_tx_packetheader.vhd"]"\
 "[file normalize "$origin_dir/tb/kria_generic/src/mipi_tx_axil/mipi_tx_2l_axil_bfm.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/mipi_tx_control/mipi_tx_control.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/mipi_tx_control/mipi_tx_control_fifo_xilinx.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/mipi_tx_control/mipi_tx_control_in_frame.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/mipi_tx_control/mipi_tx_control_in_packet.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/mipi_tx_control/mipi_tx_control_out.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/mipi_tx_control/mipi_tx_control_padding_2.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx_fifo/mipi_tx_fifo.vhd"]"\
 "[file normalize "$origin_dir/../common/src/verification/mipi_tx_bfm/mipi_tx_lane_hs_lp_mixer.vhd"]"\
 "[file normalize "$origin_dir/tb/kria_generic/src/mipi_tx_axil/reg_bank/mipi_tx_reg_bank_pkg.vhd"]"\
 "[file normalize "$origin_dir/tb/kria_generic/src/mipi_tx_axil/reg_bank/mipi_tx_reg_bank.vhd"]"\
 "[file normalize "$origin_dir/tb/kria_generic/src/mipi_tx_sim_bfm.vhd"]"\
 "[file normalize "$origin_dir/tb/kria_generic/src/mipi_tx_axil/xilinx_mipi_axil_2l/xilinx_mipi_tx_axil_2l.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx/xilinx_mipi_tx_2l_ip/xilinx_mipi_tx_ip_2l.vhd"]"\
 "[file normalize "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx/xilinx_mipi_tx_packet_if.vhd"]"\
 "[file normalize "$origin_dir/tb/kria_generic/src/test_bench.sv"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../../tmp/tmp.b4bqZbxp3m/delivery_prj_build/common/ip_repo"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "kria_generic"
...
set script_file "kria_generic_RC_0_1_0.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../../tmp/tmp.b4bqZbxp3m/delivery_prj_build"]"
...
# Create project
create_project ${_xil_proj_name_} -part xck26-sfvc784-2LV-c
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../common/ip_repo"]" $obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "kria_generic_top_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/constr/kria_generic_pinout_constraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/kria_generic_pinout_constraints.xdc"
...
# Set 'sim_tc_001' fileset file properties for remote files
set file "$origin_dir/tb/kria_generic/src/tb_local_params.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj

set file "$origin_dir/../common/src/verification/sv/zynq_fpga_bfm.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../common/src/axi4_stream/axi4_pipeline_stage_2.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/utils/ccam_utils/xilinx/ccam_utils.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/axi4_stream/axi4s_cfg_fifo_merge_2_1.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/utils/ccam_evt_formats.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/tb/kria_generic/src/pkg/ccam_evt_types.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/utils/ccam_evt_types_v3.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/axi4_stream/axi4s_cfg_sync_fifo.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/axi4_stream/axi4s_demux_1_2.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/axi4_stream/axi4s_fork_1_2.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/axi4_stream/axi4s_mux_2_1.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/axi4_stream/axi4s_sync_fifo_xpm.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/verification/axil_master_bfm/axi_lite_master_bfm.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/axi4_stream/axis_ready_pipe.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/axi4_stream/axis_serializer.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/utils/ccam_evt_type_v2_1.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/verification/clk_rst_bfm/clk_rst_bfm.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/verification/clk_rst_bfm/clk_rst_gen.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx/xilinx_mipi_tx_2l_ip/crc16_2lane/crc16_2lane.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/verification/evt_verification_pkg.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/verification/evt20_sequencer.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/verification/evt20_stream_reader.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/verification/evt30_sequencer.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/verification/evt30_stream_reader.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/verification/evt_record_generic.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/verification/evt_stream_reader.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/verification/file_stream_reader.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx/xilinx_mipi_tx_2l_ip/mipi_tx_delay_ctrl/mipi_csi_tx_delay_ctrl.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx/xilinx_mipi_tx_2l_ip/mipi_tx_dphy/mipi_csi_tx_dphy.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx/xilinx_mipi_tx_2l_ip/mipi_tx_packetheader/mipi_csi_tx_packetheader.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/tb/kria_generic/src/mipi_tx_axil/mipi_tx_2l_axil_bfm.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/mipi_tx_control/mipi_tx_control.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/mipi_tx_control/mipi_tx_control_fifo_xilinx.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/mipi_tx_control/mipi_tx_control_in_frame.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/mipi_tx_control/mipi_tx_control_in_packet.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/mipi_tx_control/mipi_tx_control_out.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/mipi_tx_control/mipi_tx_control_padding_2.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx_fifo/mipi_tx_fifo.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/verification/mipi_tx_bfm/mipi_tx_lane_hs_lp_mixer.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/tb/kria_generic/src/mipi_tx_axil/reg_bank/mipi_tx_reg_bank_pkg.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/tb/kria_generic/src/mipi_tx_axil/reg_bank/mipi_tx_reg_bank.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/tb/kria_generic/src/mipi_tx_sim_bfm.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/tb/kria_generic/src/mipi_tx_axil/xilinx_mipi_axil_2l/xilinx_mipi_tx_axil_2l.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx/xilinx_mipi_tx_2l_ip/xilinx_mipi_tx_ip_2l.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../common/src/mipi/mipi_tx/xilinx_mipi_tx/xilinx_mipi_tx_packet_if.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/tb/kria_generic/src/test_bench.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sim_tc_001]
set_property -name "generic" -value "AXIL_MIPI_TX_PATTERN_FILE_G=\"../../../../../../psee_generic/tb/kria_generic/tc_001/pattern/axil_bfm_mipi_tx.pat\" AXIL_FPGA_PATTERN_FILE_G=\"../../../../../../psee_generic/tb/kria_generic/tc_001/pattern/axil_bfm_fpga.pat\" IN_DATA_FILE_PATH_G=\"../../../../../../psee_generic/tb/kria_generic/tc_001/pattern/in_evt_file.evt\" REF_DATA_FILE_PATH_G=\"../../../../../../psee_generic/tb/kria_generic/tc_001/pattern/ref_evt_file.evt\" INIT_MEM_FILE_PATH_G=\"../../../../../../psee_generic/tb/kria_generic/tc_001/pattern/kria_generic_init_mem.mem\" OUT_MEM_FILE_PATH_G=\"../../../../../../psee_generic/tb/kria_generic/tc_001/pattern/kria_generic_out_mem.mem\"" -objects $obj
...
set_property -name "xsim.simulate.saif_scope" -value "kria_generic_top_wrapper" -objects $obj
...
# Proc to create BD kria_generic_top
proc cr_bd_kria_generic_top { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name kria_generic_top
  ...
  set axis_tkeep_handler_0 [ create_bd_cell -type ip -vlnv prophesee.ai:ip:axis_tkeep_handler:1.0 axis_tkeep_handler_0 ]

  # Create instance: core_clk_const, and set properties
  set core_clk_const [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 core_clk_const ]
  ...
  # Create instance: core_clock_sys_reset_0, and set properties
  set core_clock_sys_reset_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 core_clock_sys_reset_0 ]
  ...
  set ps_host_if_0 [ create_bd_cell -type ip -vlnv prophesee.ai:ip:ps_host_if:2.0 ps_host_if_0 ]
  ...
  # Create instance: ps_vcc_constant, and set properties
  set ps_vcc_constant [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 ps_vcc_constant ]
  ...
  set_property -dict [list \
    CONFIG.Coe_File {../../../../../../../../psee_generic/kria_generic_system_register.coe} \
...
\
  ...
  connect_bd_intf_net -intf_net axi_interconnect_master_lpd_M03_AXI [get_bd_intf_pins axi_interconnect_master_lpd/M03_AXI] [get_bd_intf_pins ps_host_if_0/s_axi]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_master_lpd_M06_AXI [get_bd_intf_pins axi_interconnect_master_lpd/M06_AXI] [get_bd_intf_pins axis_tkeep_handler_0/s_axi]
  ...
  connect_bd_net -net aux_reset_in_1 [get_bd_pins ps_system_reset/aux_reset_in] [get_bd_pins ps_system_reset/dcm_locked] [get_bd_pins ps_system_reset/ext_reset_in] [get_bd_pins ps_vcc_constant/dout]
  ...
  connect_bd_net -net core_clock_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_master_lpd/M02_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M03_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M04_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M05_ARESETN] [get_bd_pins core_clock_sys_reset_0/peripheral_aresetn] [get_bd_pins event_stream_smart_t_0/arst_n] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aresetn] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aresetn] [get_bd_pins ps_host_if_0/core_arst_n]
  connect_bd_net -net core_clock_sys_reset_0_peripheral_reset [get_bd_pins axis_tkeep_handler_0/rst] [get_bd_pins core_clock_sys_reset_0/peripheral_reset] [get_bd_pins event_stream_smart_t_0/srst] [get_bd_pins ps_host_if_0/core_srst]
  connect_bd_net -net hier_0_peripheral_reset [get_bd_pins ps_host_if_0/ext_srst] [get_bd_pins ps_system_reset/peripheral_reset]
  ...
  connect_bd_net -net ps_system_reset_peripheral_reset [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_interconnect_hp0/M00_ARESETN] [get_bd_pins axi_interconnect_hp0/S00_ARESETN] [get_bd_pins axi_interconnect_hp0/S01_ARESETN] [get_bd_pins axi_interconnect_hp0/S02_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M00_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M01_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M06_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M07_ARESETN] [get_bd_pins axi_interconnect_master_lpd/S00_ARESETN] [get_bd_pins axis_tkeep_handler_0/s_axi_aresetn] [get_bd_pins ps_host_if_0/ext_arst_n] [get_bd_pins ps_host_if_0/s_axi_aresetn] [get_bd_pins ps_system_reset/peripheral_aresetn]
  connect_bd_net -net ps_vcc_constant1_dout [get_bd_pins core_clk_const/dout] [get_bd_pins core_clock_sys_reset_0/aux_reset_in] [get_bd_pins core_clock_sys_reset_0/dcm_locked] [get_bd_pins core_clock_sys_reset_0/ext_reset_in]
...
# End of cr_bd_kria_generic_top()
cr_bd_kria_generic_top ""
set_property REGISTERED_WITH_MANAGER "1" [get_files kria_generic_top.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files kria_generic_top.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse kria_generic_top.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../../../tmp/tmp.b4bqZbxp3m/delivery_prj_build/kria_generic.gen/sources_1/bd/kria_generic_top/hdl/kria_generic_top_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse kria_generic_top.bd] -top]
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xck26-sfvc784-2LV-c -flow {Vivado Implementation 2022} -strategy "Performance_Retiming" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
