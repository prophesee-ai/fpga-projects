...
#
# kv260_RC_0_2_4.tcl: Tcl script for re-creating project 'kv260'
#
# Generated by Vivado on Mon Jun 10 16:59:17 CEST 2024
...
proc cr_bd_kv260_top { parentCell } {
  ...
  set_property -dict [list \
    CONFIG.Coe_File {/sim/lrobin/work/system-rtl-wip/build/prj/kv260/kv260.srcs/sources_1/imports/kv260_system_register.coe} \
  ...
  set zynq_processing_system [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.5 zynq_processing_system ]
  set_property -dict [list \
...
\
  ...
  connect_bd_net -net aux_reset_in_1 [get_bd_pins vcc_constant/dout] [get_bd_pins ps_system_reset/ext_reset_in] [get_bd_pins ps_system_reset/aux_reset_in] [get_bd_pins ps_system_reset/dcm_locked]
  connect_bd_net -net axi_dma_mm2s_introut [get_bd_pins axi_dma/mm2s_introut] [get_bd_pins PL_PS_IRQ/In0]
  connect_bd_net -net axi_dma_s2mm_introut [get_bd_pins axi_dma/s2mm_introut] [get_bd_pins PL_PS_IRQ/In1]
  connect_bd_net -net axi_iic_0_iic2intc_irpt [get_bd_pins axi_iic_0/iic2intc_irpt] [get_bd_pins PL_PS_IRQ/In2]
  ...
  connect_bd_net -net hier_0_pl_resetn0 [get_bd_pins zynq_processing_system/pl_resetn0] [get_bd_pins core_clock_0/resetn]
  connect_bd_net -net mipi_csi2_rx_subsyst_0_csirxss_csi_irq [get_bd_pins mipi_csi2_rx_subsyst_0/csirxss_csi_irq] [get_bd_pins PL_PS_IRQ/In3]
  connect_bd_net -net pipeline_system_reset_peripheral_reset [get_bd_pins ps_system_reset/peripheral_reset] [get_bd_pins event_stream_smart_t_0/srst]
  connect_bd_net -net ps_system_reset_interconnect_aresetn [get_bd_pins ps_system_reset/interconnect_aresetn] [get_bd_pins axi_interconnect_hp0/ARESETN] [get_bd_pins axi_interconnect_master_lpd/ARESETN]
  connect_bd_net -net ps_system_reset_peripheral_reset [get_bd_pins ps_system_reset/peripheral_aresetn] [get_bd_pins axis_tkeep_handler_0/aresetn] [get_bd_pins event_stream_smart_t_0/arst_n] [get_bd_pins ps_host_if_0/aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_interconnect_hp0/S00_ARESETN] [get_bd_pins axi_interconnect_hp0/M00_ARESETN] [get_bd_pins axi_interconnect_hp0/S01_ARESETN] [get_bd_pins axi_interconnect_hp0/S02_ARESETN] [get_bd_pins axi_interconnect_master_lpd/S00_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M00_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M01_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M02_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M03_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M04_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M05_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M06_ARESETN] [get_bd_pins axi_interconnect_master_lpd/M07_ARESETN] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aresetn] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aresetn]
  connect_bd_net -net top_kria_fan_en_b [get_bd_pins xlslice_0/Dout] [get_bd_ports fan_en_b]
  connect_bd_net -net zynq_processing_system_hier_emio_ttc0_wave_o [get_bd_pins zynq_processing_system/emio_ttc0_wave_o] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net zynq_processing_system_pl_clk0 [get_bd_pins zynq_processing_system/pl_clk0] [get_bd_pins axis_tkeep_handler_0/aclk] [get_bd_pins event_stream_smart_t_0/clk] [get_bd_pins ps_host_if_0/aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_dma/m_axi_sg_aclk] [get_bd_pins axi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_interconnect_hp0/ACLK] [get_bd_pins axi_interconnect_hp0/S00_ACLK] [get_bd_pins axi_interconnect_hp0/M00_ACLK] [get_bd_pins axi_interconnect_hp0/S01_ACLK] [get_bd_pins axi_interconnect_hp0/S02_ACLK] [get_bd_pins axi_interconnect_master_lpd/ACLK] [get_bd_pins axi_interconnect_master_lpd/S00_ACLK] [get_bd_pins axi_interconnect_master_lpd/M00_ACLK] [get_bd_pins axi_interconnect_master_lpd/M01_ACLK] [get_bd_pins axi_interconnect_master_lpd/M02_ACLK] [get_bd_pins axi_interconnect_master_lpd/M03_ACLK] [get_bd_pins axi_interconnect_master_lpd/M04_ACLK] [get_bd_pins axi_interconnect_master_lpd/M05_ACLK] [get_bd_pins axi_interconnect_master_lpd/M06_ACLK] [get_bd_pins axi_interconnect_master_lpd/M07_ACLK] [get_bd_pins core_clock_0/clk_in1] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aclk] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aclk] [get_bd_pins ps_system_reset/slowest_sync_clk] [get_bd_pins zynq_processing_system/maxihpm0_fpd_aclk] [get_bd_pins zynq_processing_system/saxihpc0_fpd_aclk]
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xck26-sfvc784-2LV-c -flow {Vivado Implementation 2024} -strategy "Performance_Retiming" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
