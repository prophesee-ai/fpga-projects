...
#
# Generated by Vivado on Fri Oct 18 17:17:25 CEST 2024
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/projects/kv260/hdl/kv260_v1_0_0.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/coe/kv260_system_register.coe"]"\
 "[file normalize "$origin_dir/projects/kv260/constr/kv260_pinout.xdc"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/projects/kv260/tb/src/tb_local_params.sv"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/zynq_fpga_bfm.sv"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/axi4_pipeline_stage_2.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/ccam_utils.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/axi4s_cfg_fifo_merge_2_1.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/ccam_evt_formats.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/ccam_evt_types.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/ccam_evt_types_v3.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/axi4s_cfg_sync_fifo.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/axi4s_demux_1_2.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/axi4s_fork_1_2.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/axi4s_mux_2_1.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/axi4s_sync_fifo_xpm.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/axi_lite_master_bfm.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/axis_ready_pipe.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/axis_serializer.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/ccam_evt_type_v2_1.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/clk_rst_bfm.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/clk_rst_gen.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/crc16_2lane.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/evt_verification_pkg.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/evt20_sequencer.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/evt20_stream_reader.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/evt30_sequencer.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/evt30_stream_reader.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/evt_record_generic.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/evt_stream_reader.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/file_stream_reader.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_csi_tx_delay_ctrl.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_csi_tx_dphy.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_csi_tx_packetheader.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_tx_2l_axil_bfm.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_tx_control.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_tx_control_fifo_xilinx.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_tx_control_in_frame.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_tx_control_in_packet.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_tx_control_out.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_tx_control_padding_2.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_tx_fifo.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_tx_lane_hs_lp_mixer.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_tx_reg_bank_pkg.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_tx_reg_bank.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/mipi_tx_sim_bfm.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/xilinx_mipi_tx_axil_2l.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/xilinx_mipi_tx_ip_2l.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/xilinx_mipi_tx_packet_if.vhd"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/src/kv260_tb.sv"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/tc_001/pattern/kv260_init_mem.mem"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/tc_001/pattern/axil_bfm_fpga.pat"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/tc_001/pattern/axil_bfm_mipi_tx.pat"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/tc_001/pattern/in_evt_file.evt"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/tc_001/pattern/ref_evt_file.evt"]"\
 "[file normalize "$origin_dir/projects/kv260/tb/tc_001/pattern/kv260_out_mem.mem"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
if { $validate_required } {
  if { [checkRequiredFiles $origin_dir] } {
    puts "Tcl file $script_file is valid. All files required for project creation are accesible. "
  } else {
    puts "Tcl file $script_file is not valid. Not all files required for project creation are accesible. "
    return
  }
}

# Create project
create_project ${_xil_proj_name_} "$origin_dir/build/projects/kv260" -part xck26-sfvc784-2LV-c
...
set obj [get_filesets sources_1]
set_property -name "top" -value "kv260_v1_0_0" -objects $obj
...
set file "[file normalize ${origin_dir}/projects/kv260/constr/kv260_pinout.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "constr/kv260_pinout.xdc"
...
set file "$origin_dir/projects/kv260/tb/src/tb_local_params.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/zynq_fpga_bfm.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/axi4_pipeline_stage_2.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/ccam_utils.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/axi4s_cfg_fifo_merge_2_1.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/ccam_evt_formats.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/ccam_evt_types.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/ccam_evt_types_v3.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/axi4s_cfg_sync_fifo.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/axi4s_demux_1_2.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/axi4s_fork_1_2.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/axi4s_mux_2_1.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/axi4s_sync_fifo_xpm.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/axi_lite_master_bfm.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/axis_ready_pipe.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/axis_serializer.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/ccam_evt_type_v2_1.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/clk_rst_bfm.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/clk_rst_gen.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/crc16_2lane.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/evt_verification_pkg.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/evt20_sequencer.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/evt20_stream_reader.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/evt30_sequencer.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/evt30_stream_reader.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/evt_record_generic.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/evt_stream_reader.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/file_stream_reader.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_csi_tx_delay_ctrl.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_csi_tx_dphy.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_csi_tx_packetheader.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_tx_2l_axil_bfm.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_tx_control.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_tx_control_fifo_xilinx.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_tx_control_in_frame.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_tx_control_in_packet.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_tx_control_out.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_tx_control_padding_2.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_tx_fifo.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_tx_lane_hs_lp_mixer.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_tx_reg_bank_pkg.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_tx_reg_bank.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/mipi_tx_sim_bfm.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/xilinx_mipi_tx_axil_2l.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/xilinx_mipi_tx_ip_2l.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/xilinx_mipi_tx_packet_if.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/src/kv260_tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/tc_001/pattern/kv260_init_mem.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "Memory Initialization Files" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/tc_001/pattern/axil_bfm_fpga.pat"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "Memory Initialization Files" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/tc_001/pattern/axil_bfm_mipi_tx.pat"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "Memory Initialization Files" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/tc_001/pattern/in_evt_file.evt"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "Memory Initialization Files" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/tc_001/pattern/ref_evt_file.evt"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "Memory Initialization Files" -objects $file_obj

set file "$origin_dir/projects/kv260/tb/tc_001/pattern/kv260_out_mem.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_tc_001] [list "*$file"]]
set_property -name "file_type" -value "Memory Initialization Files" -objects $file_obj
...
set obj [get_filesets sim_tc_001]
set_property -name "generic" -value "AXIL_MIPI_TX_PATTERN_FILE_G=axil_bfm_mipi_tx.pat AXIL_FPGA_PATTERN_FILE_G=axil_bfm_fpga.pat IN_DATA_FILE_PATH_G=in_evt_file.evt REF_DATA_FILE_PATH_G=ref_evt_file.evt INIT_MEM_FILE_PATH_G=kv260_init_mem.mem OUT_MEM_FILE_PATH_G=kv260_out_mem.mem" -objects $obj
set_property -name "top" -value "kv260_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "vhdl_generic" -value "AXIL_MIPI_TX_PATTERN_FILE_G=axil_bfm_mipi_tx.pat AXIL_FPGA_PATTERN_FILE_G=axil_bfm_fpga.pat IN_DATA_FILE_PATH_G=in_evt_file.evt REF_DATA_FILE_PATH_G=ref_evt_file.evt INIT_MEM_FILE_PATH_G=kv260_init_mem.mem OUT_MEM_FILE_PATH_G=kv260_out_mem.mem" -objects $obj
...
# Proc to create BD kv260
proc cr_bd_kv260 { parentCell } {
  ...
  prophesee.ai:ip:ps_host_if:3.0\
  ...
  set ps_host_if_0 [ create_bd_cell -type ip -vlnv prophesee.ai:ip:ps_host_if:3.0 ps_host_if_0 ]
  ...
  set_property -dict [list \
    CONFIG.Coe_File [get_files -of [get_filesets sources_1] kv260_system_register.coe] \
...
\
  ...
  connect_bd_intf_net -intf_net event_stream_smart_t_0_m_axis [get_bd_intf_pins event_stream_smart_t_0/m_axis] [get_bd_intf_pins ps_host_if_0/s_axis]
...
# End of cr_bd_kv260()
cr_bd_kv260 ""
set_property REGISTERED_WITH_MANAGER "1" [get_files kv260.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files kv260.bd ] 
...
file delete -force $origin_dir/build/projects/kv260/kv260.srcs/sim_1
